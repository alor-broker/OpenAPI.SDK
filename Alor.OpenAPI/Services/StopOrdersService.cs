...
namespace Alor.OpenAPI.Services
{
    internal class StopOrdersService : IStopOrdersService
    {
        ...
        public Task<StopOrderSimple> MdV2ClientsExchangePortfolioStopOrdersOrderIdGetSimpleAsync(Exchange exchange, string portfolio, int orderId) =>
            MdV2ClientsExchangePortfolioStopOrdersOrderIdGetAsync<StopOrderSimple>(Format.Simple, exchange, portfolio, orderId, _cancellationTokenSource.Token);

        public Task<StopOrderSlim> MdV2ClientsExchangePortfolioStopOrdersOrderIdGetSlimAsync(Exchange exchange, string portfolio, int orderId) =>
            MdV2ClientsExchangePortfolioStopOrdersOrderIdGetAsync<StopOrderSlim>(Format.Slim, exchange, portfolio, orderId, _cancellationTokenSource.Token);

        public Task<StopOrderHeavy> MdV2ClientsExchangePortfolioStopOrdersOrderIdGetHeavyAsync(Exchange exchange, string portfolio, int orderId) =>
            MdV2ClientsExchangePortfolioStopOrdersOrderIdGetAsync<StopOrderHeavy>(Format.Heavy, exchange, portfolio, orderId, _cancellationTokenSource.Token);

        public Task<ICollection<StopOrderSimple>> MdV2ClientsExchangePortfolioStopOrdersGetSimpleAsync(Exchange exchange, string portfolio) =>
            MdV2ClientsExchangePortfolioStopOrdersGetAsync<ICollection<StopOrderSimple>>(Format.Simple, exchange, portfolio, _cancellationTokenSource.Token);

        public Task<ICollection<StopOrderSlim>> MdV2ClientsExchangePortfolioStopOrdersGetSlimAsync(Exchange exchange, string portfolio) =>
            MdV2ClientsExchangePortfolioStopOrdersGetAsync<ICollection<StopOrderSlim>>(Format.Slim, exchange, portfolio, _cancellationTokenSource.Token);

        public Task<ICollection<StopOrderHeavy>> MdV2ClientsExchangePortfolioStopOrdersGetHeavyAsync(Exchange exchange, string portfolio) =>
            MdV2ClientsExchangePortfolioStopOrdersGetAsync<ICollection<StopOrderHeavy>>(Format.Heavy, exchange, portfolio, _cancellationTokenSource.Token);
        ...
        private Task<T> MdV2ClientsExchangePortfolioStopOrdersGetAsync<T>(Format format, Exchange exchange, string? portfolio, CancellationToken cancellationToken)
        {
            ...
            var uriBuilder = new UriBuilder(_baseUrl)
                             {
                                 Path = $"{_baseUrl.AbsolutePath.TrimEnd('/')}/md/v2/clients/{exchange}/{Uri.EscapeDataString(portfolio)}/stoporders",
                                 Query = $"format={format}"
                             };
        ...
        private Task<T> MdV2ClientsExchangePortfolioStopOrdersOrderIdGetAsync<T>(Format format, Exchange exchange, string? portfolio, int orderId, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(portfolio))
                throw new ArgumentNullException(nameof(portfolio));
            ...
            var uriBuilder = new UriBuilder(_baseUrl)
                             {
                                 Path = $"{_baseUrl.AbsolutePath.TrimEnd('/')}/md/v2/clients/{exchange}/{Uri.EscapeDataString(portfolio)}/stoporders/{orderId}",
                                 Query = $"format={format}"
                             };
            ...
            bool? activate, CancellationToken cancellationToken)
        {
            ...
            var uriBuilder = new UriBuilder(_baseUrl)
                             {
                                 Path = $"{_baseUrl.AbsolutePath.TrimEnd('/')}/commandapi/warptrans/TRADE/v2/client/orders/actions/stop/{stopOrderId}",
                             };

            return _apiHttpClient.ProcessRequest<OrderActionLimitMarket>(HttpMethod.Post, uriBuilder.Uri, cancellationToken, body: body, needXReqid: true, needAuthorization: true);
        }

        private Task<OrderActionLimitMarket> CommandapiWarptransTradeV2ClientOrdersActionsStopLimitStopOrderIdPutAsync(int stopOrderId,
            Side side, Condition condition, decimal triggerPrice, DateTime stopEndUtcTime, int quantity,
            decimal price, string? symbol, Exchange exchange, string? portfolio, string? instrumentGroup,
            TimeInForce timeInForce, int? icebergFixed, decimal? icebergVariance, int? protectingSeconds, bool? activate,
            CancellationToken cancellationToken)
        {
            ...
            var uriBuilder = new UriBuilder(_baseUrl)
                             {
                                 Path = $"{_baseUrl.AbsolutePath.TrimEnd('/')}/commandapi/warptrans/TRADE/v2/client/orders/actions/stopLimit/{stopOrderId}",
                             };
