...
namespace Alor.OpenAPI.Models
{
    ...
    internal sealed class SubscriptionTrade : IEquatable<SubscriptionTrade>, IValidatableObject
    {
        ...
        /// <include file='../XmlDocs/CoreModels.xml' path='Docs/Members[@name="wsSubTradesGetAndSubscribe"]/Member[@name="wsSubTradesGetAndSubscribe"]/*' />
        public SubscriptionTrade(string? portfolio = default, bool? skipHistory = default, 
        ...
        public string? Opcode { get; private set; } = "TradesGetAndSubscribeV2";
        ...
        /// <include file='../XmlDocs/CoreModels.xml' path='Docs/Members[@name="wsSubTradesGetAndSubscribe"]/Member[@name="frequency"]/*' />
