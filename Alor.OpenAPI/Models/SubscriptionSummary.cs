...
namespace Alor.OpenAPI.Models
{
    ...
    internal sealed class SubscriptionSummary : IEquatable<SubscriptionSummary>, IValidatableObject
    {
        ...
        ///          path='Docs/Members[@name="wsSubSummariesGetAndSubscribeV2"]
        ///               /Member[@name="wsSubSummariesGetAndSubscribeV2"]
        ///               /param[
        ///                      @name="portfolio" or @name="skipHistory" or @name="exchange"
        ///                      or @name="format" or @name="frequency" or @name="guid"
        ///                     ]'/>
        public SubscriptionSummary(string? portfolio = null, bool? skipHistory = null, 
