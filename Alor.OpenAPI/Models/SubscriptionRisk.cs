...
namespace Alor.OpenAPI.Models
{
    ...
    internal sealed class SubscriptionRisk : IEquatable<SubscriptionRisk>, IValidatableObject
    {
        ...
        ///          path='Docs/Members[@name="wsSubRisksGetAndSubscribe"]
        ///               /Member[@name="wsSubRisksGetAndSubscribe"]
        ///               /param[
        ///                      @name="portfolio" or @name="skipHistory" or @name="exchange"
        ///                      or @name="format" or @name="frequency" or @name="guid"
        ///                     ]'/>
        public SubscriptionRisk(string? portfolio = null, bool? skipHistory = null, 
