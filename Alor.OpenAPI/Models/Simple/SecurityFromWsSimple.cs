...
{
    [DataContract]
    public sealed class SecurityFromWsSimple : IEquatable<SecurityFromWsSimple>, IValidatableObject
    {
        ...
        ///                     ]'/>
        public SecurityFromWsSimple(string? symbol = null, Exchange? exchange = null,
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityFromWsSimple {").Append(Environment.NewLine);
        ...
        private static bool EqualsHelper(SecurityFromWsSimple? first, SecurityFromWsSimple? second) =>
        ...
        public bool Equals(SecurityFromWsSimple? other)
        {
        ...
        public override bool Equals(object? obj) => Equals(obj as SecurityFromWsSimple);

        private static bool Equals(SecurityFromWsSimple? first, SecurityFromWsSimple? second) =>
            first?.Equals(second) ?? first == (object?)second;

        public static bool operator ==(SecurityFromWsSimple? first, SecurityFromWsSimple? second) => Equals(first, second);
