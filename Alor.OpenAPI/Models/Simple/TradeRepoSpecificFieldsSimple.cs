...
{
    [DataContract]
    public sealed class TradeRepoSpecificFieldsSimple : IEquatable<TradeRepoSpecificFieldsSimple>, IValidatableObject
    {
        ...
        ///                     ]'/>
        public TradeRepoSpecificFieldsSimple(decimal? repoRate = null, string? extRef = null, int? repoTerm = null,
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TradeRepoSpecificFieldsSimple {").Append(Environment.NewLine);
        ...
        private static bool Equals(TradeRepoSpecificFieldsSimple? first, TradeRepoSpecificFieldsSimple? second) =>
            first?.Equals(second) ?? first == (object?)second;

        public static bool operator ==(TradeRepoSpecificFieldsSimple? first, TradeRepoSpecificFieldsSimple? second) => Equals(first, second);
