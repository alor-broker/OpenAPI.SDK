...
{
    [DataContract]
    public sealed class PositionSimple : IEquatable<PositionSimple>, IValidatableObject
    {
        ...
        ///                      or @name="qtyBatch" or @name="openQtyBatch" or @name="qty" or @name="open" or @name="dailyUnrealisedPl"
        ///                      or @name="unrealisedPl" or @name="isCurrency" or @name="existing"
        ///                     ]'/>
        public PositionSimple(decimal? volume = null, decimal? currentVolume = null,
            ...
            decimal? qtyTFuture = null, decimal? qtyT0Batch = null,
            decimal? qtyT1Batch = null, decimal? qtyT2Batch = null,
            decimal? qtyTFutureBatch = null, decimal? qtyBatch = null,
            decimal? openQtyBatch = null, decimal? qty = null,
            decimal? open = null, decimal? dailyUnrealisedPl = null,
        ...
        /// <include file='../../XmlDocs/CoreModels.xml' path='Docs/Members[@name="responsePosition"]/Member[@name="qty"]/*' />
        [DataMember(Name = "qty", EmitDefaultValue = false)]
        public decimal? Qty { get; init; }

        /// <include file='../../XmlDocs/CoreModels.xml' path='Docs/Members[@name="responsePosition"]/Member[@name="open"]/*' />
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PositionSimple {").Append(Environment.NewLine);
        ...
        private static bool EqualsHelper(PositionSimple? first, PositionSimple? second) =>
        ...
        public bool Equals(PositionSimple? other)
        {
        ...
        public override bool Equals(object? obj) => Equals(obj as PositionSimple);

        private static bool Equals(PositionSimple? first, PositionSimple? second) =>
            first?.Equals(second) ?? first == (object?)second;

        public static bool operator ==(PositionSimple? first, PositionSimple? second) => Equals(first, second);
