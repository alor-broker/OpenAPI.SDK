...
{
    [DataContract]
    public sealed class StopOrderHeavy : IEquatable<StopOrderHeavy>, IValidatableObject
    {
        ...
        ///                     ]'/>
        public StopOrderHeavy(string? id = null, long? exchangeOrderId = null, string? symbol = null,
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StopOrderHeavy {").Append(Environment.NewLine);
        ...
        private static bool EqualsHelper(StopOrderHeavy? first, StopOrderHeavy? second) =>
            first?.Id == second?.Id &&
        ...
        public bool Equals(StopOrderHeavy? other)
        {
        ...
        public override bool Equals(object? obj) => Equals(obj as StopOrderHeavy);

        private static bool Equals(StopOrderHeavy? first, StopOrderHeavy? second) =>
            first?.Equals(second) ?? first == (object?)second;

        public static bool operator ==(StopOrderHeavy? first, StopOrderHeavy? second) => Equals(first, second);
