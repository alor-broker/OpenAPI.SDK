...
namespace Alor.OpenAPI.Models.Heavy
{
    ...
    public sealed class SummaryHeavy : IEquatable<SummaryHeavy>, IValidatableObject
    {
        ...
        ///                     ]'/>
        public SummaryHeavy(decimal? buyingPowerAtMorning = null, decimal? buyingPower = null, decimal? profit = null,
            ...
            ICollection<BuyingPowerByCurrencyHeavy>? buyingPowerByCurrency = null)
        {
